  ...
  return (
    <Box sx={{ width: "100vw", display: "flex", justifyContent: "space-evenly", my: "5rem" }}>
      ...
      <Box sx={{ width: "30%" }}>
        ...
        <Typography>
        Erik Nordlund, a gifted wedding photographer, weaves romantic tales through his camera lens. With an artistic vision and keen attention to detail, he captures love in its purest form. Erik's photographs reflect the essence of each couple, transforming their special day into a timeless visual love story.
