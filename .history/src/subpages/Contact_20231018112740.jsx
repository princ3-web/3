...
const Contact = () => {
  return (
    <Box sx={{ display: "flex" }}>
      ...
      >
        <TextField id="outlined-basic" label="Outlined" variant="outlined" sx={{margin: "0.5rem"}} />
        <TextField id="outlined-basic" label="Outlined" variant="outlined" sx={{margin: "1rem"}} />
      </Box>
    </Box>
  );
};
