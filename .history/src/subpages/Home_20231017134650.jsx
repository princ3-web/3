...
const Home = () => {
  const projects = [{ title: "project 1", image: image1 }, { title: "project 1", image: image1 }, { title: "project 1", image: image1 }, { title: "project 1", image: image1 },];
  return (
    <Box>
      <Box
        sx={{
      ...
      <Box sx={{ display: "flex", flexWrap: "wrap", justifyContent: "space-evenly" }}>
        {projects.map((item) => (
          <Box sx={{ width: "45%", mb: "2rem" }}>
            <CardMedia component="img" alt="Sample Image" image={item.image} />
