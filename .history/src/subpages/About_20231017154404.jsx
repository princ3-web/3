    ...
    >
      ...
      <Box>
        ...
        <Typography sx={{ width: "50%" }}>
          ...
          style. We value timeliness, open communication, and providing glimpses of the captured
          moments over elaborate presentations. Moreover, we appreciate the personal touch of
          face-to-face meetings, perhaps over a cup of coffee or a meal. Over the years, we have
          been fortunate to collaborate with amazing couples on their special day, but we believe it
          is still too early to judge the success of our work. Wedding photographs exist in time and
          their value is directly related to how well they continue to evoke cherished memories.
        </Typography>
        <Typography sx={{ width: "50%" }}>
          We think of wedding photography not as a single practice, but as several interlocking
          ones. Moments are inseparable from emotions, lighting is inseparable from capturing the
